...
module "k3s_nodes" {
  ...
  server_security_group_id       = module.security_groups.server_security_group_id
  worker_shared_security_group_id = module.security_groups.worker_shared_security_group_id
